...
![窃听](../images/ios-signing/1.svg)

**对称加密**

加密和解密的密钥相同即为对称加密。它的特点是：**加密解密快、传输不安全**。

![对称加密](../images/ios-signing/2.svg)
...
![解决密钥配送问题](../images/ios-signing/3.svg)
...
![单向散列函数](../images/ios-signing/4.svg)
